...
function CategoryList() {
    return (
        <div className='flex flex-wrap items-center justify-center gap-8'>
            ...
            <CategoryItem name="desserts" href="/categories/desserts" backgroundColor='#feefc9' color='#d16400' />
            <CategoryItem name="drinks" href="/categories/drinks" backgroundColor='#ffeae3' color='#f0403e' />
            <CategoryItem name="sides" href="/categories/sides" backgroundColor='#e8f5fa' color='#397a9e' />
        </div>
    )
}
